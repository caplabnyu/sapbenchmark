...
brm_predicted_lstm_Agr_P0_log <- brm(predicted~pGram.coded+(1+pGram.coded||item)+(1+pGram.coded||participant),
...
saveRDS(brm_predicted_lstm_Agr_P0_log,"brm_predicted_lstm_Agr_P0_logadd.rds")
summary(brm_predicted_lstm_Agr_P0_log)
rm(brm_predicted_lstm_Agr_P0_log)

brm_predicted_lstm_Agr_P1_log <- brm(predicted~pGram.coded+(1+pGram.coded||item)+(1+pGram.coded||participant),
...
saveRDS(brm_predicted_lstm_Agr_P1_log,"brm_predicted_lstm_Agr_P1_logadd.rds")
summary(brm_predicted_lstm_Agr_P1_log)
rm(brm_predicted_lstm_Agr_P1_log)

brm_predicted_lstm_Agr_P2_log <- brm(predicted~pGram.coded+(1+pGram.coded||item)+(1+pGram.coded||participant),
...
saveRDS(brm_predicted_lstm_Agr_P2_log,"brm_predicted_lstm_Agr_P2_logadd.rds")
summary(brm_predicted_lstm_Agr_P2_log)
rm(brm_predicted_lstm_Agr_P2_log)
