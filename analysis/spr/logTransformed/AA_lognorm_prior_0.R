...
### ROI=0
brm_prior1_emp_0_log <- brm(RT_log ~ ambiguity + height + (1+ambiguity+height||item) + (1+ambiguity+height||participant),
                              data=subset(rt.data, ROI==0&!is.na(RT)),
...
saveRDS(brm_prior1_emp_0_log, file="AA_logadd/brm_prior1_AA_emp_0_log.rds")
summary(brm_prior1_emp_0_log)
