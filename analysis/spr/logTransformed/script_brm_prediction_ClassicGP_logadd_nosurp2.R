...
brm_predicted_nosurp_GP_P2 <- brm(predicted~AMBUAMB*(SZM1+SZM2)+(1+AMBUAMB*(SZM1+SZM2)||item)+(1|participant),
...
saveRDS(brm_predicted_nosurp_GP_P2,"brm_predicted_nosurp_GP_P2_logadd.rds")