...
###ROI=0, lstm
brm_prior1_pred_lstm_0_log <- brm(predicted ~ ambiguity + height + (1+ambiguity+height||item) + (1|participant),
...
saveRDS(brm_prior1_pred_lstm_0_log, file="brm_prior1_pred_lstm_0_logadd.rds")
summary(brm_prior1_pred_lstm_0_log)



### ROI=1, lstm
brm_prior1_pred_lstm_1_log <- brm(predicted ~ ambiguity + height + (1+ambiguity+height||item) + (1|participant),
                              ...
                              warmup = 16000,
                              control = list(adapt_delta = brms_parms$adapt_delta))
saveRDS(brm_prior1_pred_lstm_1_log, file="brm_prior1_pred_lstm_1_logadd.rds")
summary(brm_prior1_pred_lstm_1_log)
### ROI=2, lstm
brm_prior1_pred_lstm_2_log <- brm(predicted ~ ambiguity + height + (1+ambiguity+height||item) + (1|participant),
                              ...
                              warmup = 16000,
                              control = list(adapt_delta = brms_parms$adapt_delta))
saveRDS(brm_prior1_pred_lstm_2_log, file="brm_prior1_pred_lstm_2_logadd.rds")
summary(brm_prior1_pred_lstm_2_log)
