...
prior1_fit <- brm(RT ~ Type_num + (0 + Type_num | participant) + (1 + Type_num | item),
                      data=verb_dat,
                      cores = 4,
                      prior = prior1,
                      iter = 4000,
...
prior1_fit_trunc <- brm(RT |trunc(lb=0) ~ Type_num + (0 + Type_num | participant) + (1 + Type_num | item),
                            data=verb_dat,
                            cores = 4,
                            prior = prior1,
                            iter = 4000,
...
prior2_fit <- brm(RT ~ Type_num + (0 + Type_num | participant) + (1 + Type_num | item),
                      data=verb_dat,
                      cores = 4,
                      prior = prior2,
                      iter = 4000,
...
prior3_fit <- brm(RT ~ Type_num + (0 + Type_num | participant) + (1 + Type_num | item),
                      data=verb_dat,
                      cores = 4,
                      prior = prior3,
                      iter = 4000,
