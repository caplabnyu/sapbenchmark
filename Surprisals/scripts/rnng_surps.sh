...
python get_rnng.py --input data/items_main.pivot.csv --output data/rnng/items_main.rnng.csv --model ../../models_pt/rnng/rnng-e80.pt --seed 0 
...
python get_rnng.py --input data/items_attach.pivot.csv --output data/rnng/items_attach.rnng.csv --model ../../models_pt/rnng/rnng-e80.pt --seed 0 

python get_rnng.py --input data/items_orc.pivot.csv --output data/rnng/items_orc.rnng.csv --model ../../models_pt/rnng/rnng-e80.pt --seed 0 
