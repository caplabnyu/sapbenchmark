...
#lstmonly_GP_P0 <- readRDS("ClassicGP/brm_predicted_GP_P0_lstmonly.rds")
#lstmonly_GP_P1 <- readRDS("ClassicGP/brm_predicted_GP_P1_lstmonly.rds")
#lstmonly_GP_P2 <- readRDS("ClassicGP/brm_predicted_GP_P2_lstmonly.rds")
#gpt2only_GP_P0 <- readRDS("ClassicGP/brm_predicted_GP_P0_gpt2only.rds")
#gpt2only_GP_P1 <- readRDS("ClassicGP/brm_predicted_GP_P1_gpt2only.rds")
#gpt2only_GP_P2 <- readRDS("ClassicGP/brm_predicted_GP_P2_gpt2only.rds")
...
gpt2_GP_P0_posterior_samp <- posterior_samples(gpt2_GP_P0, fixed=TRUE, pars=
                                                c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
lstmonly_GP_P0_posterior_samp <- posterior_samples(lstmonly_GP_P0, fixed=TRUE, pars=
                                                     c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
gpt2only_GP_P0_posterior_samp <- posterior_samples(gpt2only_GP_P0, fixed=TRUE, pars=
                                                     c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
...
gpt2_GP_P1_posterior_samp <- posterior_samples(gpt2_GP_P1, fixed=TRUE, pars=
                                                c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
lstmonly_GP_P1_posterior_samp <- posterior_samples(lstmonly_GP_P1, fixed=TRUE, pars=
                                                     c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
gpt2only_GP_P1_posterior_samp <- posterior_samples(gpt2only_GP_P1, fixed=TRUE, pars=
                                                 c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
...
gpt2_GP_P2_posterior_samp <- posterior_samples(gpt2_GP_P2, fixed=TRUE, pars=
                                                c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
lstmonly_GP_P2_posterior_samp <- posterior_samples(lstmonly_GP_P2, fixed=TRUE, pars=
                                                     c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
gpt2only_GP_P2_posterior_samp <- posterior_samples(gpt2only_GP_P2, fixed=TRUE, pars=
                                                     c("b_Intercept","b_AMBUAMB","b_SZM1","b_SZM2","b_AMBUAMB:SZM1","b_AMBUAMB:SZM2",randomslope_names))
...
lstmonly_GP_P0,gpt2only_GP_P0,lstmonly_GP_P1,gpt2only_GP_P1,lstmonly_GP_P2,gpt2only_GP_P2)
...
#saveRDS(lstmonly_GP_P0_posterior_samp,"ClassicGP/lstmonly_GP_P0_posterior_samp.rds")
#saveRDS(gpt2only_GP_P0_posterior_samp,"ClassicGP/gpt2only_GP_P0_posterior_samp.rds")
...
#saveRDS(lstmonly_GP_P1_posterior_samp,"ClassicGP/lstmonly_GP_P1_posterior_samp.rds")
#saveRDS(gpt2only_GP_P1_posterior_samp,"ClassicGP/gpt2only_GP_P1_posterior_samp.rds")
...
#saveRDS(lstmonly_GP_P2_posterior_samp,"ClassicGP/lstmonly_GP_P2_posterior_samp.rds")
#saveRDS(gpt2only_GP_P2_posterior_samp,"ClassicGP/gpt2only_GP_P2_posterior_samp.rds")
...
lstmonly_GP_P0_posterior_samp <- readRDS("ClassicGP/lstmonly_GP_P0_posterior_samp.rds")
gpt2only_GP_P0_posterior_samp <- readRDS("ClassicGP/gpt2only_GP_P0_posterior_samp.rds")
...
lstmonly_GP_P1_posterior_samp <- readRDS("ClassicGP/lstmonly_GP_P1_posterior_samp.rds")
gpt2only_GP_P1_posterior_samp <- readRDS("ClassicGP/gpt2only_GP_P1_posterior_samp.rds")
...
lstmonly_GP_P2_posterior_samp <- readRDS("ClassicGP/lstmonly_GP_P2_posterior_samp.rds")
gpt2only_GP_P2_posterior_samp <- readRDS("ClassicGP/gpt2only_GP_P2_posterior_samp.rds")
...
posterior_lstmonly_MVRR_P0 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_MVRR",ROI=0)
posterior_lstmonly_NPS_P0 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPS",ROI=0)
posterior_lstmonly_NPZ_P0 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPZ",ROI=0)
posterior_lstmonly_MVRR_P1 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_MVRR",ROI=1)
posterior_lstmonly_NPS_P1 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPS",ROI=1)
posterior_lstmonly_NPZ_P1 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPZ",ROI=1)
posterior_lstmonly_MVRR_P2 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_MVRR",ROI=2)
posterior_lstmonly_NPS_P2 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPS",ROI=2)
posterior_lstmonly_NPZ_P2 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPZ",ROI=2)
...
posterior_gpt2only_MVRR_P0 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_MVRR",ROI=0)
posterior_gpt2only_NPS_P0 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPS",ROI=0)
posterior_gpt2only_NPZ_P0 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPZ",ROI=0)
posterior_gpt2only_MVRR_P1 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_MVRR",ROI=1)
posterior_gpt2only_NPS_P1 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPS",ROI=1)
posterior_gpt2only_NPZ_P1 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPZ",ROI=1)
posterior_gpt2only_MVRR_P2 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_MVRR",ROI=2)
posterior_gpt2only_NPS_P2 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPS",ROI=2)
posterior_gpt2only_NPZ_P2 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=1:24,EOI="GPE_NPZ",ROI=2)
...
emp_GP_P0_posterior_samp[,(1+ncols):(24+ncols)] <- emp_GP_P0_posterior_samp[,2]+emp_GP_P0_posterior_samp[,(1+30):(24+30)]
emp_GP_P0_posterior_samp[,(25+ncols):(48+ncols)] <- emp_GP_P0_posterior_samp[,2]+emp_GP_P0_posterior_samp[,5]+emp_GP_P0_posterior_samp[,(1+30):(24+30)]+emp_GP_P0_posterior_samp[,(1+102):(24+102)]
emp_GP_P0_posterior_samp[,(49+ncols):(72+ncols)] <- emp_GP_P0_posterior_samp[,2]+emp_GP_P0_posterior_samp[,6]+emp_GP_P0_posterior_samp[,(1+30):(24+30)]+emp_GP_P0_posterior_samp[,(1+126):(24+126)]
emp_GP_P0_posterior_samp[,(73+ncols):(96+ncols)] <- emp_GP_P0_posterior_samp[,1]+emp_GP_P0_posterior_samp[,(1+6):(24+6)]
emp_GP_P0_posterior_samp[,(97+ncols):(120+ncols)] <- emp_GP_P0_posterior_samp[,1]+emp_GP_P0_posterior_samp[,3]+emp_GP_P0_posterior_samp[,(1+6):(24+6)]+emp_GP_P0_posterior_samp[,(1+54):(24+54)]
emp_GP_P0_posterior_samp[,(121+ncols):(144+ncols)] <- emp_GP_P0_posterior_samp[,1]+emp_GP_P0_posterior_samp[,4]+emp_GP_P0_posterior_samp[,(1+6):(24+6)]+emp_GP_P0_posterior_samp[,(1+78):(24+78)]
emp_GP_P1_posterior_samp[,(1+ncols):(24+ncols)] <- emp_GP_P1_posterior_samp[,2]+emp_GP_P1_posterior_samp[,(1+30):(24+30)]
emp_GP_P1_posterior_samp[,(25+ncols):(48+ncols)] <- emp_GP_P1_posterior_samp[,2]+emp_GP_P1_posterior_samp[,5]+emp_GP_P1_posterior_samp[,(1+30):(24+30)]+emp_GP_P1_posterior_samp[,(1+102):(24+102)]
emp_GP_P1_posterior_samp[,(49+ncols):(72+ncols)] <- emp_GP_P1_posterior_samp[,2]+emp_GP_P1_posterior_samp[,6]+emp_GP_P1_posterior_samp[,(1+30):(24+30)]+emp_GP_P1_posterior_samp[,(1+126):(24+126)]
emp_GP_P1_posterior_samp[,(73+ncols):(96+ncols)] <- emp_GP_P1_posterior_samp[,1]+emp_GP_P1_posterior_samp[,(1+6):(24+6)]
emp_GP_P1_posterior_samp[,(97+ncols):(120+ncols)] <- emp_GP_P1_posterior_samp[,1]+emp_GP_P1_posterior_samp[,3]+emp_GP_P1_posterior_samp[,(1+6):(24+6)]+emp_GP_P1_posterior_samp[,(1+54):(24+54)]
emp_GP_P1_posterior_samp[,(121+ncols):(144+ncols)] <- emp_GP_P1_posterior_samp[,1]+emp_GP_P1_posterior_samp[,4]+emp_GP_P1_posterior_samp[,(1+6):(24+6)]+emp_GP_P1_posterior_samp[,(1+78):(24+78)]
emp_GP_P2_posterior_samp[,(1+ncols):(24+ncols)] <- emp_GP_P2_posterior_samp[,2]+emp_GP_P2_posterior_samp[,(1+30):(24+30)]
emp_GP_P2_posterior_samp[,(25+ncols):(48+ncols)] <- emp_GP_P2_posterior_samp[,2]+emp_GP_P2_posterior_samp[,5]+emp_GP_P2_posterior_samp[,(1+30):(24+30)]+emp_GP_P2_posterior_samp[,(1+102):(24+102)]
emp_GP_P2_posterior_samp[,(49+ncols):(72+ncols)] <- emp_GP_P2_posterior_samp[,2]+emp_GP_P2_posterior_samp[,6]+emp_GP_P2_posterior_samp[,(1+30):(24+30)]+emp_GP_P2_posterior_samp[,(1+126):(24+126)]
emp_GP_P2_posterior_samp[,(73+ncols):(96+ncols)] <- emp_GP_P2_posterior_samp[,1]+emp_GP_P2_posterior_samp[,(1+6):(24+6)]
emp_GP_P2_posterior_samp[,(97+ncols):(120+ncols)] <- emp_GP_P2_posterior_samp[,1]+emp_GP_P2_posterior_samp[,3]+emp_GP_P2_posterior_samp[,(1+6):(24+6)]+emp_GP_P2_posterior_samp[,(1+54):(24+54)]
emp_GP_P2_posterior_samp[,(121+ncols):(144+ncols)] <- emp_GP_P2_posterior_samp[,1]+emp_GP_P2_posterior_samp[,4]+emp_GP_P2_posterior_samp[,(1+6):(24+6)]+emp_GP_P2_posterior_samp[,(1+78):(24+78)]

lstm_GP_P0_posterior_samp[,(1+ncols):(24+ncols)] <- lstm_GP_P0_posterior_samp[,2]+lstm_GP_P0_posterior_samp[,(1+30):(24+30)]
lstm_GP_P0_posterior_samp[,(25+ncols):(48+ncols)] <- lstm_GP_P0_posterior_samp[,2]+lstm_GP_P0_posterior_samp[,5]+lstm_GP_P0_posterior_samp[,(1+30):(24+30)]+lstm_GP_P0_posterior_samp[,(1+102):(24+102)]
lstm_GP_P0_posterior_samp[,(49+ncols):(72+ncols)] <- lstm_GP_P0_posterior_samp[,2]+lstm_GP_P0_posterior_samp[,6]+lstm_GP_P0_posterior_samp[,(1+30):(24+30)]+lstm_GP_P0_posterior_samp[,(1+126):(24+126)]
lstm_GP_P1_posterior_samp[,(1+ncols):(24+ncols)] <- lstm_GP_P1_posterior_samp[,2]+lstm_GP_P1_posterior_samp[,(1+30):(24+30)]
lstm_GP_P1_posterior_samp[,(25+ncols):(48+ncols)] <- lstm_GP_P1_posterior_samp[,2]+lstm_GP_P1_posterior_samp[,5]+lstm_GP_P1_posterior_samp[,(1+30):(24+30)]+lstm_GP_P1_posterior_samp[,(1+102):(24+102)]
lstm_GP_P1_posterior_samp[,(49+ncols):(72+ncols)] <- lstm_GP_P1_posterior_samp[,2]+lstm_GP_P1_posterior_samp[,6]+lstm_GP_P1_posterior_samp[,(1+30):(24+30)]+lstm_GP_P1_posterior_samp[,(1+126):(24+126)]
lstm_GP_P2_posterior_samp[,(1+ncols):(24+ncols)] <- lstm_GP_P2_posterior_samp[,2]+lstm_GP_P2_posterior_samp[,(1+30):(24+30)]
lstm_GP_P2_posterior_samp[,(25+ncols):(48+ncols)] <- lstm_GP_P2_posterior_samp[,2]+lstm_GP_P2_posterior_samp[,5]+lstm_GP_P2_posterior_samp[,(1+30):(24+30)]+lstm_GP_P2_posterior_samp[,(1+102):(24+102)]
lstm_GP_P2_posterior_samp[,(49+ncols):(72+ncols)] <- lstm_GP_P2_posterior_samp[,2]+lstm_GP_P2_posterior_samp[,6]+lstm_GP_P2_posterior_samp[,(1+30):(24+30)]+lstm_GP_P2_posterior_samp[,(1+126):(24+126)]
gpt2_GP_P0_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2_GP_P0_posterior_samp[,2]+gpt2_GP_P0_posterior_samp[,(1+30):(24+30)]
gpt2_GP_P0_posterior_samp[,(25+ncols):(48+ncols)] <- gpt2_GP_P0_posterior_samp[,2]+gpt2_GP_P0_posterior_samp[,5]+gpt2_GP_P0_posterior_samp[,(1+30):(24+30)]+gpt2_GP_P0_posterior_samp[,(1+102):(24+102)]
gpt2_GP_P0_posterior_samp[,(49+ncols):(72+ncols)] <- gpt2_GP_P0_posterior_samp[,2]+gpt2_GP_P0_posterior_samp[,6]+gpt2_GP_P0_posterior_samp[,(1+30):(24+30)]+gpt2_GP_P0_posterior_samp[,(1+126):(24+126)]
gpt2_GP_P1_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2_GP_P1_posterior_samp[,2]+gpt2_GP_P1_posterior_samp[,(1+30):(24+30)]
gpt2_GP_P1_posterior_samp[,(25+ncols):(48+ncols)] <- gpt2_GP_P1_posterior_samp[,2]+gpt2_GP_P1_posterior_samp[,5]+gpt2_GP_P1_posterior_samp[,(1+30):(24+30)]+gpt2_GP_P1_posterior_samp[,(1+102):(24+102)]
gpt2_GP_P1_posterior_samp[,(49+ncols):(72+ncols)] <- gpt2_GP_P1_posterior_samp[,2]+gpt2_GP_P1_posterior_samp[,6]+gpt2_GP_P1_posterior_samp[,(1+30):(24+30)]+gpt2_GP_P1_posterior_samp[,(1+126):(24+126)]
gpt2_GP_P2_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2_GP_P2_posterior_samp[,2]+gpt2_GP_P2_posterior_samp[,(1+30):(24+30)]
gpt2_GP_P2_posterior_samp[,(25+ncols):(48+ncols)] <- gpt2_GP_P2_posterior_samp[,2]+gpt2_GP_P2_posterior_samp[,5]+gpt2_GP_P2_posterior_samp[,(1+30):(24+30)]+gpt2_GP_P2_posterior_samp[,(1+102):(24+102)]
gpt2_GP_P2_posterior_samp[,(49+ncols):(72+ncols)] <- gpt2_GP_P2_posterior_samp[,2]+gpt2_GP_P2_posterior_samp[,6]+gpt2_GP_P2_posterior_samp[,(1+30):(24+30)]+gpt2_GP_P2_posterior_samp[,(1+126):(24+126)]
lstmonly_GP_P0_posterior_samp[,(1+ncols):(24+ncols)] <- lstmonly_GP_P0_posterior_samp[,2]+lstmonly_GP_P0_posterior_samp[,(1+30):(24+30)]
lstmonly_GP_P0_posterior_samp[,(25+ncols):(48+ncols)] <- lstmonly_GP_P0_posterior_samp[,2]+lstmonly_GP_P0_posterior_samp[,5]+lstmonly_GP_P0_posterior_samp[,(1+30):(24+30)]+lstmonly_GP_P0_posterior_samp[,(1+102):(24+102)]
lstmonly_GP_P0_posterior_samp[,(49+ncols):(72+ncols)] <- lstmonly_GP_P0_posterior_samp[,2]+lstmonly_GP_P0_posterior_samp[,6]+lstmonly_GP_P0_posterior_samp[,(1+30):(24+30)]+lstmonly_GP_P0_posterior_samp[,(1+126):(24+126)]
lstmonly_GP_P1_posterior_samp[,(1+ncols):(24+ncols)] <- lstmonly_GP_P1_posterior_samp[,2]+lstmonly_GP_P1_posterior_samp[,(1+30):(24+30)]
lstmonly_GP_P1_posterior_samp[,(25+ncols):(48+ncols)] <- lstmonly_GP_P1_posterior_samp[,2]+lstmonly_GP_P1_posterior_samp[,5]+lstmonly_GP_P1_posterior_samp[,(1+30):(24+30)]+lstmonly_GP_P1_posterior_samp[,(1+102):(24+102)]
lstmonly_GP_P1_posterior_samp[,(49+ncols):(72+ncols)] <- lstmonly_GP_P1_posterior_samp[,2]+lstmonly_GP_P1_posterior_samp[,6]+lstmonly_GP_P1_posterior_samp[,(1+30):(24+30)]+lstmonly_GP_P1_posterior_samp[,(1+126):(24+126)]
lstmonly_GP_P2_posterior_samp[,(1+ncols):(24+ncols)] <- lstmonly_GP_P2_posterior_samp[,2]+lstmonly_GP_P2_posterior_samp[,(1+30):(24+30)]
lstmonly_GP_P2_posterior_samp[,(25+ncols):(48+ncols)] <- lstmonly_GP_P2_posterior_samp[,2]+lstmonly_GP_P2_posterior_samp[,5]+lstmonly_GP_P2_posterior_samp[,(1+30):(24+30)]+lstmonly_GP_P2_posterior_samp[,(1+102):(24+102)]
lstmonly_GP_P2_posterior_samp[,(49+ncols):(72+ncols)] <- lstmonly_GP_P2_posterior_samp[,2]+lstmonly_GP_P2_posterior_samp[,6]+lstmonly_GP_P2_posterior_samp[,(1+30):(24+30)]+lstmonly_GP_P2_posterior_samp[,(1+126):(24+126)]
gpt2only_GP_P0_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2only_GP_P0_posterior_samp[,2]+gpt2only_GP_P0_posterior_samp[,(1+30):(24+30)]
gpt2only_GP_P0_posterior_samp[,(25+ncols):(48+ncols)] <- gpt2only_GP_P0_posterior_samp[,2]+gpt2only_GP_P0_posterior_samp[,5]+gpt2only_GP_P0_posterior_samp[,(1+30):(24+30)]+gpt2only_GP_P0_posterior_samp[,(1+102):(24+102)]
gpt2only_GP_P0_posterior_samp[,(49+ncols):(72+ncols)] <- gpt2only_GP_P0_posterior_samp[,2]+gpt2only_GP_P0_posterior_samp[,6]+gpt2only_GP_P0_posterior_samp[,(1+30):(24+30)]+gpt2only_GP_P0_posterior_samp[,(1+126):(24+126)]
gpt2only_GP_P1_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2only_GP_P1_posterior_samp[,2]+gpt2only_GP_P1_posterior_samp[,(1+30):(24+30)]
gpt2only_GP_P1_posterior_samp[,(25+ncols):(48+ncols)] <- gpt2only_GP_P1_posterior_samp[,2]+gpt2only_GP_P1_posterior_samp[,5]+gpt2only_GP_P1_posterior_samp[,(1+30):(24+30)]+gpt2only_GP_P1_posterior_samp[,(1+102):(24+102)]
gpt2only_GP_P1_posterior_samp[,(49+ncols):(72+ncols)] <- gpt2only_GP_P1_posterior_samp[,2]+gpt2only_GP_P1_posterior_samp[,6]+gpt2only_GP_P1_posterior_samp[,(1+30):(24+30)]+gpt2only_GP_P1_posterior_samp[,(1+126):(24+126)]
gpt2only_GP_P2_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2only_GP_P2_posterior_samp[,2]+gpt2only_GP_P2_posterior_samp[,(1+30):(24+30)]
gpt2only_GP_P2_posterior_samp[,(25+ncols):(48+ncols)] <- gpt2only_GP_P2_posterior_samp[,2]+gpt2only_GP_P2_posterior_samp[,5]+gpt2only_GP_P2_posterior_samp[,(1+30):(24+30)]+gpt2only_GP_P2_posterior_samp[,(1+102):(24+102)]
gpt2only_GP_P2_posterior_samp[,(49+ncols):(72+ncols)] <- gpt2only_GP_P2_posterior_samp[,2]+gpt2only_GP_P2_posterior_samp[,6]+gpt2only_GP_P2_posterior_samp[,(1+30):(24+30)]+gpt2only_GP_P2_posterior_samp[,(1+126):(24+126)]
nosurp_GP_P0_posterior_samp[,(1+ncols):(24+ncols)] <- nosurp_GP_P0_posterior_samp[,2]+nosurp_GP_P0_posterior_samp[,(1+30):(24+30)]
nosurp_GP_P0_posterior_samp[,(25+ncols):(48+ncols)] <- nosurp_GP_P0_posterior_samp[,2]+nosurp_GP_P0_posterior_samp[,5]+nosurp_GP_P0_posterior_samp[,(1+30):(24+30)]+nosurp_GP_P0_posterior_samp[,(1+102):(24+102)]
nosurp_GP_P0_posterior_samp[,(49+ncols):(72+ncols)] <- nosurp_GP_P0_posterior_samp[,2]+nosurp_GP_P0_posterior_samp[,6]+nosurp_GP_P0_posterior_samp[,(1+30):(24+30)]+nosurp_GP_P0_posterior_samp[,(1+126):(24+126)]
nosurp_GP_P1_posterior_samp[,(1+ncols):(24+ncols)] <- nosurp_GP_P1_posterior_samp[,2]+nosurp_GP_P1_posterior_samp[,(1+30):(24+30)]
nosurp_GP_P1_posterior_samp[,(25+ncols):(48+ncols)] <- nosurp_GP_P1_posterior_samp[,2]+nosurp_GP_P1_posterior_samp[,5]+nosurp_GP_P1_posterior_samp[,(1+30):(24+30)]+nosurp_GP_P1_posterior_samp[,(1+102):(24+102)]
nosurp_GP_P1_posterior_samp[,(49+ncols):(72+ncols)] <- nosurp_GP_P1_posterior_samp[,2]+nosurp_GP_P1_posterior_samp[,6]+nosurp_GP_P1_posterior_samp[,(1+30):(24+30)]+nosurp_GP_P1_posterior_samp[,(1+126):(24+126)]
nosurp_GP_P2_posterior_samp[,(1+ncols):(24+ncols)] <- nosurp_GP_P2_posterior_samp[,2]+nosurp_GP_P2_posterior_samp[,(1+30):(24+30)]
nosurp_GP_P2_posterior_samp[,(25+ncols):(48+ncols)] <- nosurp_GP_P2_posterior_samp[,2]+nosurp_GP_P2_posterior_samp[,30]+nosurp_GP_P2_posterior_samp[,(1+30):(24+30)]+nosurp_GP_P2_posterior_samp[,(1+102):(24+102)]
nosurp_GP_P2_posterior_samp[,(49+ncols):(72+ncols)] <- nosurp_GP_P2_posterior_samp[,2]+nosurp_GP_P2_posterior_samp[,30]+nosurp_GP_P2_posterior_samp[,(1+30):(24+30)]+nosurp_GP_P2_posterior_samp[,(1+126):(24+126)]
...
for(i in 1:24){
  ...
  posterior_lstmonly_MVRR_P0[i,]$mean <- mean(lstmonly_GP_P0_posterior_samp[,i+ncols])
  posterior_lstmonly_MVRR_P0[i,]$SE <- sd(lstmonly_GP_P0_posterior_samp[,i+ncols])
  posterior_lstmonly_MVRR_P0[i,]$upper <- quantile(lstmonly_GP_P0_posterior_samp[,i+ncols],0.975)
  posterior_lstmonly_MVRR_P0[i,]$lower <- quantile(lstmonly_GP_P0_posterior_samp[,i+ncols],0.025)
  posterior_lstmonly_MVRR_P1[i,]$mean <- mean(lstmonly_GP_P1_posterior_samp[,i+ncols])
  posterior_lstmonly_MVRR_P1[i,]$SE <- sd(lstmonly_GP_P1_posterior_samp[,i+ncols])
  posterior_lstmonly_MVRR_P1[i,]$upper <- quantile(lstmonly_GP_P1_posterior_samp[,i+ncols],0.975)
  posterior_lstmonly_MVRR_P1[i,]$lower <- quantile(lstmonly_GP_P1_posterior_samp[,i+ncols],0.025)
  posterior_lstmonly_MVRR_P2[i,]$mean <- mean(lstmonly_GP_P2_posterior_samp[,i+ncols])
  posterior_lstmonly_MVRR_P2[i,]$SE <- sd(lstmonly_GP_P2_posterior_samp[,i+ncols])
  posterior_lstmonly_MVRR_P2[i,]$upper <- quantile(lstmonly_GP_P2_posterior_samp[,i+ncols],0.975)
  posterior_lstmonly_MVRR_P2[i,]$lower <- quantile(lstmonly_GP_P2_posterior_samp[,i+ncols],0.025)
  posterior_lstmonly_NPS_P0[i,]$mean <- mean(lstmonly_GP_P0_posterior_samp[,i+ncols+24])
  posterior_lstmonly_NPS_P0[i,]$SE <- sd(lstmonly_GP_P0_posterior_samp[,i+ncols+24])
  posterior_lstmonly_NPS_P0[i,]$upper <- quantile(lstmonly_GP_P0_posterior_samp[,i+ncols+24],0.975)
  posterior_lstmonly_NPS_P0[i,]$lower <- quantile(lstmonly_GP_P0_posterior_samp[,i+ncols+24],0.025)
  posterior_lstmonly_NPS_P1[i,]$mean <- mean(lstmonly_GP_P1_posterior_samp[,i+ncols+24])
  posterior_lstmonly_NPS_P1[i,]$SE <- sd(lstmonly_GP_P1_posterior_samp[,i+ncols+24])
  posterior_lstmonly_NPS_P1[i,]$upper <- quantile(lstmonly_GP_P1_posterior_samp[,i+ncols+24],0.975)
  posterior_lstmonly_NPS_P1[i,]$lower <- quantile(lstmonly_GP_P1_posterior_samp[,i+ncols+24],0.025)
  posterior_lstmonly_NPS_P2[i,]$mean <- mean(lstmonly_GP_P2_posterior_samp[,i+ncols+24])
  posterior_lstmonly_NPS_P2[i,]$SE <- sd(lstmonly_GP_P2_posterior_samp[,i+ncols+24])
  posterior_lstmonly_NPS_P2[i,]$upper <- quantile(lstmonly_GP_P2_posterior_samp[,i+ncols+24],0.975)
  posterior_lstmonly_NPS_P2[i,]$lower <- quantile(lstmonly_GP_P2_posterior_samp[,i+ncols+24],0.025)
  posterior_lstmonly_NPZ_P0[i,]$mean <- mean(lstmonly_GP_P0_posterior_samp[,i+ncols+48])
  posterior_lstmonly_NPZ_P0[i,]$SE <- sd(lstmonly_GP_P0_posterior_samp[,i+ncols+48])
  posterior_lstmonly_NPZ_P0[i,]$upper <- quantile(lstmonly_GP_P0_posterior_samp[,i+ncols+48],0.975)
  posterior_lstmonly_NPZ_P0[i,]$lower <- quantile(lstmonly_GP_P0_posterior_samp[,i+ncols+48],0.025)
  posterior_lstmonly_NPZ_P1[i,]$mean <- mean(lstmonly_GP_P1_posterior_samp[,i+ncols+48])
  posterior_lstmonly_NPZ_P1[i,]$SE <- sd(lstmonly_GP_P1_posterior_samp[,i+ncols+48])
  posterior_lstmonly_NPZ_P1[i,]$upper <- quantile(lstmonly_GP_P1_posterior_samp[,i+ncols+48],0.975)
  posterior_lstmonly_NPZ_P1[i,]$lower <- quantile(lstmonly_GP_P1_posterior_samp[,i+ncols+48],0.025)
  posterior_lstmonly_NPZ_P2[i,]$mean <- mean(lstmonly_GP_P2_posterior_samp[,i+ncols+48])
  posterior_lstmonly_NPZ_P2[i,]$SE <- sd(lstmonly_GP_P2_posterior_samp[,i+ncols+48])
  posterior_lstmonly_NPZ_P2[i,]$upper <- quantile(lstmonly_GP_P2_posterior_samp[,i+ncols+48],0.975)
  posterior_lstmonly_NPZ_P2[i,]$lower <- quantile(lstmonly_GP_P2_posterior_samp[,i+ncols+48],0.025)
  posterior_gpt2only_MVRR_P0[i,]$mean <- mean(gpt2only_GP_P0_posterior_samp[,i+ncols])
  posterior_gpt2only_MVRR_P0[i,]$SE <- sd(gpt2only_GP_P0_posterior_samp[,i+ncols])
  posterior_gpt2only_MVRR_P0[i,]$upper <- quantile(gpt2only_GP_P0_posterior_samp[,i+ncols],0.975)
  posterior_gpt2only_MVRR_P0[i,]$lower <- quantile(gpt2only_GP_P0_posterior_samp[,i+ncols],0.025)
  posterior_gpt2only_MVRR_P1[i,]$mean <- mean(gpt2only_GP_P1_posterior_samp[,i+ncols])
  posterior_gpt2only_MVRR_P1[i,]$SE <- sd(gpt2only_GP_P1_posterior_samp[,i+ncols])
  posterior_gpt2only_MVRR_P1[i,]$upper <- quantile(gpt2only_GP_P1_posterior_samp[,i+ncols],0.975)
  posterior_gpt2only_MVRR_P1[i,]$lower <- quantile(gpt2only_GP_P1_posterior_samp[,i+ncols],0.025)
  posterior_gpt2only_MVRR_P2[i,]$mean <- mean(gpt2only_GP_P2_posterior_samp[,i+ncols])
  posterior_gpt2only_MVRR_P2[i,]$SE <- sd(gpt2only_GP_P2_posterior_samp[,i+ncols])
  posterior_gpt2only_MVRR_P2[i,]$upper <- quantile(gpt2only_GP_P2_posterior_samp[,i+ncols],0.975)
  posterior_gpt2only_MVRR_P2[i,]$lower <- quantile(gpt2only_GP_P2_posterior_samp[,i+ncols],0.025)
  posterior_gpt2only_NPS_P0[i,]$mean <- mean(gpt2only_GP_P0_posterior_samp[,i+ncols+24])
  posterior_gpt2only_NPS_P0[i,]$SE <- sd(gpt2only_GP_P0_posterior_samp[,i+ncols+24])
  posterior_gpt2only_NPS_P0[i,]$upper <- quantile(gpt2only_GP_P0_posterior_samp[,i+ncols+24],0.975)
  posterior_gpt2only_NPS_P0[i,]$lower <- quantile(gpt2only_GP_P0_posterior_samp[,i+ncols+24],0.025)
  posterior_gpt2only_NPS_P1[i,]$mean <- mean(gpt2only_GP_P1_posterior_samp[,i+ncols+24])
  posterior_gpt2only_NPS_P1[i,]$SE <- sd(gpt2only_GP_P1_posterior_samp[,i+ncols+24])
  posterior_gpt2only_NPS_P1[i,]$upper <- quantile(gpt2only_GP_P1_posterior_samp[,i+ncols+24],0.975)
  posterior_gpt2only_NPS_P1[i,]$lower <- quantile(gpt2only_GP_P1_posterior_samp[,i+ncols+24],0.025)
  posterior_gpt2only_NPS_P2[i,]$mean <- mean(gpt2only_GP_P2_posterior_samp[,i+ncols+24])
  posterior_gpt2only_NPS_P2[i,]$SE <- sd(gpt2only_GP_P2_posterior_samp[,i+ncols+24])
  posterior_gpt2only_NPS_P2[i,]$upper <- quantile(gpt2only_GP_P2_posterior_samp[,i+ncols+24],0.975)
  posterior_gpt2only_NPS_P2[i,]$lower <- quantile(gpt2only_GP_P2_posterior_samp[,i+ncols+24],0.025)
  posterior_gpt2only_NPZ_P0[i,]$mean <- mean(gpt2only_GP_P0_posterior_samp[,i+ncols+48])
  posterior_gpt2only_NPZ_P0[i,]$SE <- sd(gpt2only_GP_P0_posterior_samp[,i+ncols+48])
  posterior_gpt2only_NPZ_P0[i,]$upper <- quantile(gpt2only_GP_P0_posterior_samp[,i+ncols+48],0.975)
  posterior_gpt2only_NPZ_P0[i,]$lower <- quantile(gpt2only_GP_P0_posterior_samp[,i+ncols+48],0.025)
  posterior_gpt2only_NPZ_P1[i,]$mean <- mean(gpt2only_GP_P1_posterior_samp[,i+ncols+48])
  posterior_gpt2only_NPZ_P1[i,]$SE <- sd(gpt2only_GP_P1_posterior_samp[,i+ncols+48])
  posterior_gpt2only_NPZ_P1[i,]$upper <- quantile(gpt2only_GP_P1_posterior_samp[,i+ncols+48],0.975)
  posterior_gpt2only_NPZ_P1[i,]$lower <- quantile(gpt2only_GP_P1_posterior_samp[,i+ncols+48],0.025)
  posterior_gpt2only_NPZ_P2[i,]$mean <- mean(gpt2only_GP_P2_posterior_samp[,i+ncols+48])
  posterior_gpt2only_NPZ_P2[i,]$SE <- sd(gpt2only_GP_P2_posterior_samp[,i+ncols+48])
  posterior_gpt2only_NPZ_P2[i,]$upper <- quantile(gpt2only_GP_P2_posterior_samp[,i+ncols+48],0.975)
  posterior_gpt2only_NPZ_P2[i,]$lower <- quantile(gpt2only_GP_P2_posterior_samp[,i+ncols+48],0.025)
...
by_item_unamb <- data.frame(item=c(posterior_emp_unambMVRR_P0$item,posterior_emp_unambMVRR_P1$item,posterior_emp_unambMVRR_P2$item,posterior_emp_unambNPS_P0$item,posterior_emp_unambNPS_P1$item,posterior_emp_unambNPS_P2$item,posterior_emp_unambNPZ_P0$item,posterior_emp_unambNPZ_P1$item,posterior_emp_unambNPZ_P2$item),
                               ROI=c(posterior_emp_unambMVRR_P0$ROI,posterior_emp_unambMVRR_P1$ROI,posterior_emp_unambMVRR_P2$ROI,posterior_emp_unambNPS_P0$ROI,posterior_emp_unambNPS_P1$ROI,posterior_emp_unambNPS_P2$ROI,posterior_emp_unambNPZ_P0$ROI,posterior_emp_unambNPZ_P1$ROI,posterior_emp_unambNPZ_P2$ROI),
                               coef=rep(c("unambMVRR","unambNPS","unambNPZ"),each=72),
                               mean=c(posterior_emp_unambMVRR_P0$mean,posterior_emp_unambMVRR_P1$mean,posterior_emp_unambMVRR_P2$mean,posterior_emp_unambNPS_P0$mean,posterior_emp_unambNPS_P1$mean,posterior_emp_unambNPS_P2$mean,posterior_emp_unambNPZ_P0$mean,posterior_emp_unambNPZ_P1$mean,posterior_emp_unambNPZ_P2$mean),
                               lower=c(posterior_emp_unambMVRR_P0$lower,posterior_emp_unambMVRR_P1$lower,posterior_emp_unambMVRR_P2$lower,posterior_emp_unambNPS_P0$lower,posterior_emp_unambNPS_P1$lower,posterior_emp_unambNPS_P2$lower,posterior_emp_unambNPZ_P0$lower,posterior_emp_unambNPZ_P1$lower,posterior_emp_unambNPZ_P2$lower),
                               upper=c(posterior_emp_unambMVRR_P0$upper,posterior_emp_unambMVRR_P1$upper,posterior_emp_unambMVRR_P2$upper,posterior_emp_unambNPS_P0$upper,posterior_emp_unambNPS_P1$upper,posterior_emp_unambNPS_P2$upper,posterior_emp_unambNPZ_P0$upper,posterior_emp_unambNPZ_P1$upper,posterior_emp_unambNPZ_P2$upper))
...
by_item_lstmonly <- data.frame(item=c(posterior_lstmonly_MVRR_P0$item,posterior_lstmonly_MVRR_P1$item,posterior_lstmonly_MVRR_P2$item,posterior_lstmonly_NPS_P0$item,posterior_lstmonly_NPS_P1$item,posterior_lstmonly_NPS_P2$item,posterior_lstmonly_NPZ_P0$item,posterior_lstmonly_NPZ_P1$item,posterior_lstmonly_NPZ_P2$item),
                               ROI=c(posterior_lstmonly_MVRR_P0$ROI,posterior_lstmonly_MVRR_P1$ROI,posterior_lstmonly_MVRR_P2$ROI,posterior_lstmonly_NPS_P0$ROI,posterior_lstmonly_NPS_P1$ROI,posterior_lstmonly_NPS_P2$ROI,posterior_lstmonly_NPZ_P0$ROI,posterior_lstmonly_NPZ_P1$ROI,posterior_lstmonly_NPZ_P2$ROI),
                               coef=rep(c("GPE_MVRR","GPE_NPS","GPE_NPZ"),each=72),
                               mean=c(posterior_lstmonly_MVRR_P0$mean,posterior_lstmonly_MVRR_P1$mean,posterior_lstmonly_MVRR_P2$mean,posterior_lstmonly_NPS_P0$mean,posterior_lstmonly_NPS_P1$mean,posterior_lstmonly_NPS_P2$mean,posterior_lstmonly_NPZ_P0$mean,posterior_lstmonly_NPZ_P1$mean,posterior_lstmonly_NPZ_P2$mean),
                               lower=c(posterior_lstmonly_MVRR_P0$lower,posterior_lstmonly_MVRR_P1$lower,posterior_lstmonly_MVRR_P2$lower,posterior_lstmonly_NPS_P0$lower,posterior_lstmonly_NPS_P1$lower,posterior_lstmonly_NPS_P2$lower,posterior_lstmonly_NPZ_P0$lower,posterior_lstmonly_NPZ_P1$lower,posterior_lstmonly_NPZ_P2$lower),
                               upper=c(posterior_lstmonly_MVRR_P0$upper,posterior_lstmonly_MVRR_P1$upper,posterior_lstmonly_MVRR_P2$upper,posterior_lstmonly_NPS_P0$upper,posterior_lstmonly_NPS_P1$upper,posterior_lstmonly_NPS_P2$upper,posterior_lstmonly_NPZ_P0$upper,posterior_lstmonly_NPZ_P1$upper,posterior_lstmonly_NPZ_P2$upper))
by_item_gpt2only <- data.frame(item=c(posterior_gpt2only_MVRR_P0$item,posterior_gpt2only_MVRR_P1$item,posterior_gpt2only_MVRR_P2$item,posterior_gpt2only_NPS_P0$item,posterior_gpt2only_NPS_P1$item,posterior_gpt2only_NPS_P2$item,posterior_gpt2only_NPZ_P0$item,posterior_gpt2only_NPZ_P1$item,posterior_gpt2only_NPZ_P2$item),
                               ROI=c(posterior_gpt2only_MVRR_P0$ROI,posterior_gpt2only_MVRR_P1$ROI,posterior_gpt2only_MVRR_P2$ROI,posterior_gpt2only_NPS_P0$ROI,posterior_gpt2only_NPS_P1$ROI,posterior_gpt2only_NPS_P2$ROI,posterior_gpt2only_NPZ_P0$ROI,posterior_gpt2only_NPZ_P1$ROI,posterior_gpt2only_NPZ_P2$ROI),
                               coef=rep(c("GPE_MVRR","GPE_NPS","GPE_NPZ"),each=72),
                               mean=c(posterior_gpt2only_MVRR_P0$mean,posterior_gpt2only_MVRR_P1$mean,posterior_gpt2only_MVRR_P2$mean,posterior_gpt2only_NPS_P0$mean,posterior_gpt2only_NPS_P1$mean,posterior_gpt2only_NPS_P2$mean,posterior_gpt2only_NPZ_P0$mean,posterior_gpt2only_NPZ_P1$mean,posterior_gpt2only_NPZ_P2$mean),
                               lower=c(posterior_gpt2only_MVRR_P0$lower,posterior_gpt2only_MVRR_P1$lower,posterior_gpt2only_MVRR_P2$lower,posterior_gpt2only_NPS_P0$lower,posterior_gpt2only_NPS_P1$lower,posterior_gpt2only_NPS_P2$lower,posterior_gpt2only_NPZ_P0$lower,posterior_gpt2only_NPZ_P1$lower,posterior_gpt2only_NPZ_P2$lower),
                               upper=c(posterior_gpt2only_MVRR_P0$upper,posterior_gpt2only_MVRR_P1$upper,posterior_gpt2only_MVRR_P2$upper,posterior_gpt2only_NPS_P0$upper,posterior_gpt2only_NPS_P1$upper,posterior_gpt2only_NPS_P2$upper,posterior_gpt2only_NPZ_P0$upper,posterior_gpt2only_NPZ_P1$upper,posterior_gpt2only_NPZ_P2$upper))
...
by_item_unamb <- arrange(by_item_unamb,item,ROI,coef)
...
saveRDS(by_item_unamb,"ClassicGP/by_item_unamb.rds")
...
saveRDS(by_item_lstmonly,"ClassicGP/by_item_lstmonly.rds")
saveRDS(by_item_gpt2only,"ClassicGP/by_item_gpt2only.rds")
...
by_construction_lstmonly <- data.frame(ROI=rep(c(0,1,2),3),coef=rep(c("GPE_MVRR","GPE_NPS","GPE_NPZ"),each=3),mean=c(mean(lstmonly_GP_P0_posterior_samp$b_AMBUAMB),mean(lstmonly_GP_P1_posterior_samp$b_AMBUAMB),mean(lstmonly_GP_P2_posterior_samp$b_AMBUAMB),mean(lstmonly_GP_P0_posterior_samp$b_AMBUAMB+lstmonly_GP_P0_posterior_samp$`b_AMBUAMB:SZM1`),mean(lstmonly_GP_P1_posterior_samp$b_AMBUAMB+lstmonly_GP_P1_posterior_samp$`b_AMBUAMB:SZM1`),mean(lstmonly_GP_P2_posterior_samp$b_AMBUAMB+lstmonly_GP_P2_posterior_samp$`b_AMBUAMB:SZM1`),mean(lstmonly_GP_P0_posterior_samp$b_AMBUAMB+lstmonly_GP_P0_posterior_samp$`b_AMBUAMB:SZM2`),mean(lstmonly_GP_P1_posterior_samp$b_AMBUAMB+lstmonly_GP_P1_posterior_samp$`b_AMBUAMB:SZM2`),mean(lstmonly_GP_P2_posterior_samp$b_AMBUAMB+lstmonly_GP_P2_posterior_samp$`b_AMBUAMB:SZM2`)),
                                       lower=c(quantile(lstmonly_GP_P0_posterior_samp$b_AMBUAMB,0.025),quantile(lstmonly_GP_P1_posterior_samp$b_AMBUAMB,0.025),quantile(lstmonly_GP_P2_posterior_samp$b_AMBUAMB,0.025),quantile(lstmonly_GP_P0_posterior_samp$b_AMBUAMB+lstmonly_GP_P0_posterior_samp$`b_AMBUAMB:SZM1`,0.025),quantile(lstmonly_GP_P1_posterior_samp$b_AMBUAMB+lstmonly_GP_P1_posterior_samp$`b_AMBUAMB:SZM1`,0.025),quantile(lstmonly_GP_P2_posterior_samp$b_AMBUAMB+lstmonly_GP_P2_posterior_samp$`b_AMBUAMB:SZM1`,0.025),quantile(lstmonly_GP_P0_posterior_samp$b_AMBUAMB+lstmonly_GP_P0_posterior_samp$`b_AMBUAMB:SZM2`,0.025),quantile(lstmonly_GP_P1_posterior_samp$b_AMBUAMB+lstmonly_GP_P1_posterior_samp$`b_AMBUAMB:SZM2`,0.025),quantile(lstmonly_GP_P2_posterior_samp$b_AMBUAMB+lstmonly_GP_P2_posterior_samp$`b_AMBUAMB:SZM2`,0.025)),
                                       upper=c(quantile(lstmonly_GP_P0_posterior_samp$b_AMBUAMB,0.975),quantile(lstmonly_GP_P1_posterior_samp$b_AMBUAMB,0.975),quantile(lstmonly_GP_P2_posterior_samp$b_AMBUAMB,0.975),quantile(lstmonly_GP_P0_posterior_samp$b_AMBUAMB+lstmonly_GP_P0_posterior_samp$`b_AMBUAMB:SZM1`,0.975),quantile(lstmonly_GP_P1_posterior_samp$b_AMBUAMB+lstmonly_GP_P1_posterior_samp$`b_AMBUAMB:SZM1`,0.975),quantile(lstmonly_GP_P2_posterior_samp$b_AMBUAMB+lstmonly_GP_P2_posterior_samp$`b_AMBUAMB:SZM1`,0.975),quantile(lstmonly_GP_P0_posterior_samp$b_AMBUAMB+lstmonly_GP_P0_posterior_samp$`b_AMBUAMB:SZM2`,0.975),quantile(lstmonly_GP_P1_posterior_samp$b_AMBUAMB+lstmonly_GP_P1_posterior_samp$`b_AMBUAMB:SZM2`,0.975),quantile(lstmonly_GP_P2_posterior_samp$b_AMBUAMB+lstmonly_GP_P2_posterior_samp$`b_AMBUAMB:SZM2`,0.975)))
by_construction_gpt2only <- data.frame(ROI=rep(c(0,1,2),3),coef=rep(c("GPE_MVRR","GPE_NPS","GPE_NPZ"),each=3),mean=c(mean(gpt2only_GP_P0_posterior_samp$b_AMBUAMB),mean(gpt2only_GP_P1_posterior_samp$b_AMBUAMB),mean(gpt2only_GP_P2_posterior_samp$b_AMBUAMB),mean(gpt2only_GP_P0_posterior_samp$b_AMBUAMB+gpt2only_GP_P0_posterior_samp$`b_AMBUAMB:SZM1`),mean(gpt2only_GP_P1_posterior_samp$b_AMBUAMB+gpt2only_GP_P1_posterior_samp$`b_AMBUAMB:SZM1`),mean(gpt2only_GP_P2_posterior_samp$b_AMBUAMB+gpt2only_GP_P2_posterior_samp$`b_AMBUAMB:SZM1`),mean(gpt2only_GP_P0_posterior_samp$b_AMBUAMB+gpt2only_GP_P0_posterior_samp$`b_AMBUAMB:SZM2`),mean(gpt2only_GP_P1_posterior_samp$b_AMBUAMB+gpt2only_GP_P1_posterior_samp$`b_AMBUAMB:SZM2`),mean(gpt2only_GP_P2_posterior_samp$b_AMBUAMB+gpt2only_GP_P2_posterior_samp$`b_AMBUAMB:SZM2`)),
                                       lower=c(quantile(gpt2only_GP_P0_posterior_samp$b_AMBUAMB,0.025),quantile(gpt2only_GP_P1_posterior_samp$b_AMBUAMB,0.025),quantile(gpt2only_GP_P2_posterior_samp$b_AMBUAMB,0.025),quantile(gpt2only_GP_P0_posterior_samp$b_AMBUAMB+gpt2only_GP_P0_posterior_samp$`b_AMBUAMB:SZM1`,0.025),quantile(gpt2only_GP_P1_posterior_samp$b_AMBUAMB+gpt2only_GP_P1_posterior_samp$`b_AMBUAMB:SZM1`,0.025),quantile(gpt2only_GP_P2_posterior_samp$b_AMBUAMB+gpt2only_GP_P2_posterior_samp$`b_AMBUAMB:SZM1`,0.025),quantile(gpt2only_GP_P0_posterior_samp$b_AMBUAMB+gpt2only_GP_P0_posterior_samp$`b_AMBUAMB:SZM2`,0.025),quantile(gpt2only_GP_P1_posterior_samp$b_AMBUAMB+gpt2only_GP_P1_posterior_samp$`b_AMBUAMB:SZM2`,0.025),quantile(gpt2only_GP_P2_posterior_samp$b_AMBUAMB+gpt2only_GP_P2_posterior_samp$`b_AMBUAMB:SZM2`,0.025)),
                                       upper=c(quantile(gpt2only_GP_P0_posterior_samp$b_AMBUAMB,0.975),quantile(gpt2only_GP_P1_posterior_samp$b_AMBUAMB,0.975),quantile(gpt2only_GP_P2_posterior_samp$b_AMBUAMB,0.975),quantile(gpt2only_GP_P0_posterior_samp$b_AMBUAMB+gpt2only_GP_P0_posterior_samp$`b_AMBUAMB:SZM1`,0.975),quantile(gpt2only_GP_P1_posterior_samp$b_AMBUAMB+gpt2only_GP_P1_posterior_samp$`b_AMBUAMB:SZM1`,0.975),quantile(gpt2only_GP_P2_posterior_samp$b_AMBUAMB+gpt2only_GP_P2_posterior_samp$`b_AMBUAMB:SZM1`,0.975),quantile(gpt2only_GP_P0_posterior_samp$b_AMBUAMB+gpt2only_GP_P0_posterior_samp$`b_AMBUAMB:SZM2`,0.975),quantile(gpt2only_GP_P1_posterior_samp$b_AMBUAMB+gpt2only_GP_P1_posterior_samp$`b_AMBUAMB:SZM2`,0.975),quantile(gpt2only_GP_P2_posterior_samp$b_AMBUAMB+gpt2only_GP_P2_posterior_samp$`b_AMBUAMB:SZM2`,0.975)))
...
saveRDS(by_construction_lstmonly,"ClassicGP/by_construction_lstmonly.rds")
saveRDS(by_construction_gpt2only,"ClassicGP/by_construction_gpt2only.rds")
saveRDS(by_construction_nosurp,"ClassicGP/by_construction_nosurp.rds")


#P0
sampled_correlations_P0 <- data.frame(Correlation=rep(NA,15000),EOI=rep(c("GPE_MVRR","GPE_NPS","GPE_NPZ"),5000),model=rep(c("lstm","lstm","lstm","gpt2","gpt2","gpt2","nosurp","nosurp","nosurp","lstmonly","lstmonly","lstmonly","gpt2only","gpt2only","gpt2only"),1000),ROI=0)
for(i in 1:1000){
  posterior_onesampleeachitem <- data.frame(emp=rep(NA,72),lstm=rep(NA,72),gpt2=rep(NA,72),nosurp=rep(NA,72),lstmonly=rep(NA,72),gpt2only=rep(NA,72),EOI=c(rep("GPE_MVRR",24),rep("GPE_NPS",24),rep("GPE_NPZ",24)))
  for(j in 1:24){
    ...
    posterior_onesampleeachitem[j,5] <- sample(lstmonly_GP_P0_posterior_samp[,j+ncols],1)
    posterior_onesampleeachitem[j,6] <- sample(gpt2only_GP_P0_posterior_samp[,j+ncols],1)
    ...
    posterior_onesampleeachitem[j+24,5] <- sample(lstmonly_GP_P0_posterior_samp[,j+24+ncols],1)
    posterior_onesampleeachitem[j+24,6] <- sample(gpt2only_GP_P0_posterior_samp[,j+24+ncols],1)
    ...
    posterior_onesampleeachitem[j+48,5] <- sample(lstmonly_GP_P0_posterior_samp[,j+48+ncols],1)
    posterior_onesampleeachitem[j+48,6] <- sample(gpt2only_GP_P0_posterior_samp[,j+48+ncols],1)
  }
  sampled_correlations_P0[((i-1)*15+1):((i-1)*15+15),'Correlation'] <- c(cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,2])$estimate,
                                                            ...
                                                            cor.test(posterior_onesampleeachitem[49:72,1],posterior_onesampleeachitem[49:72,5])$estimate,
                                                            ...
                                                            cor.test(posterior_onesampleeachitem[49:72,1],posterior_onesampleeachitem[49:72,6])$estimate)
}
#P0

#P1
sampled_correlations_P1 <- data.frame(Correlation=rep(NA,15000),EOI=rep(c("GPE_MVRR","GPE_NPS","GPE_NPZ"),5000),model=rep(c("lstm","lstm","lstm","gpt2","gpt2","gpt2","nosurp","nosurp","nosurp","lstmonly","lstmonly","lstmonly","gpt2only","gpt2only","gpt2only"),1000),ROI=1)
for(i in 1:1000){
  posterior_onesampleeachitem <- data.frame(emp=rep(NA,72),lstm=rep(NA,72),gpt2=rep(NA,72),nosurp=rep(NA,72),lstmonly=rep(NA,72),gpt2only=rep(NA,72),EOI=c(rep("GPE_MVRR",24),rep("GPE_NPS",24),rep("GPE_NPZ",24)))
  for(j in 1:24){
    ...
    posterior_onesampleeachitem[j,5] <- sample(lstmonly_GP_P1_posterior_samp[,j+ncols],1)
    posterior_onesampleeachitem[j,6] <- sample(gpt2only_GP_P1_posterior_samp[,j+ncols],1)
    ...
    posterior_onesampleeachitem[j+24,5] <- sample(lstmonly_GP_P1_posterior_samp[,j+24+ncols],1)
    posterior_onesampleeachitem[j+24,6] <- sample(gpt2only_GP_P1_posterior_samp[,j+24+ncols],1)
    ...
    posterior_onesampleeachitem[j+48,5] <- sample(lstmonly_GP_P1_posterior_samp[,j+48+ncols],1)
    posterior_onesampleeachitem[j+48,6] <- sample(gpt2only_GP_P1_posterior_samp[,j+48+ncols],1)
  }
  sampled_correlations_P1[((i-1)*15+1):((i-1)*15+15),'Correlation'] <- c(cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,2])$estimate,
                                                                         cor.test(posterior_onesampleeachitem[25:48,1],posterior_onesampleeachitem[25:48,2])$estimate,
                                                                         cor.test(posterior_onesampleeachitem[49:72,1],posterior_onesampleeachitem[49:72,2])$estimate,
                                                                         cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,3])$estimate,
                                                                         cor.test(posterior_onesampleeachitem[25:48,1],posterior_onesampleeachitem[25:48,3])$estimate,
...
#P2
sampled_correlations_P2 <- data.frame(Correlation=rep(NA,15000),EOI=rep(c("GPE_MVRR","GPE_NPS","GPE_NPZ"),5000),model=rep(c("lstm","lstm","lstm","gpt2","gpt2","gpt2","nosurp","nosurp","nosurp","lstmonly","lstmonly","lstmonly","gpt2only","gpt2only","gpt2only"),1000),ROI=2)
for(i in 1:1000){
  posterior_onesampleeachitem <- data.frame(emp=rep(NA,72),lstm=rep(NA,72),gpt2=rep(NA,72),nosurp=rep(NA,72),lstmonly=rep(NA,72),gpt2only=rep(NA,72),EOI=c(rep("GPE_MVRR",24),rep("GPE_NPS",24),rep("GPE_NPZ",24)))
  for(j in 1:24){
    ...
    posterior_onesampleeachitem[j,5] <- sample(lstmonly_GP_P2_posterior_samp[,j+ncols],1)
    posterior_onesampleeachitem[j,6] <- sample(gpt2only_GP_P2_posterior_samp[,j+ncols],1)
    ...
    posterior_onesampleeachitem[j+24,5] <- sample(lstmonly_GP_P2_posterior_samp[,j+24+ncols],1)
    posterior_onesampleeachitem[j+24,6] <- sample(gpt2only_GP_P2_posterior_samp[,j+24+ncols],1)
    ...
    posterior_onesampleeachitem[j+48,5] <- sample(lstmonly_GP_P2_posterior_samp[,j+48+ncols],1)
    posterior_onesampleeachitem[j+48,6] <- sample(gpt2only_GP_P2_posterior_samp[,j+48+ncols],1)
  }
  sampled_correlations_P2[((i-1)*15+1):((i-1)*15+15),'Correlation'] <- c(cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,2])$estimate,
                                                                         cor.test(posterior_onesampleeachitem[25:48,1],posterior_onesampleeachitem[25:48,2])$estimate,
                                                                         cor.test(posterior_onesampleeachitem[49:72,1],posterior_onesampleeachitem[49:72,2])$estimate,
                                                                         cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,3])$estimate,
                                                                         cor.test(posterior_onesampleeachitem[25:48,1],posterior_onesampleeachitem[25:48,3])$estimate,
...
cor.test(posterior_emp_MVRR_P0$mean,posterior_gpt2only_MVRR_P0$mean)$estimate
cor.test(posterior_emp_NPS_P0$mean,posterior_gpt2only_NPS_P0$mean)$estimate
cor.test(posterior_emp_NPZ_P0$mean,posterior_gpt2only_NPZ_P0$mean)$estimate
cor.test(posterior_emp_MVRR_P0$mean,posterior_lstmonly_MVRR_P0$mean)$estimate
cor.test(posterior_emp_NPS_P0$mean,posterior_lstmonly_NPS_P0$mean)$estimate
cor.test(posterior_emp_NPZ_P0$mean,posterior_lstmonly_NPZ_P0$mean)$estimate
...
cor.test(posterior_emp_MVRR_P1$mean,posterior_gpt2only_MVRR_P1$mean)$estimate
cor.test(posterior_emp_NPS_P1$mean,posterior_gpt2only_NPS_P1$mean)$estimate
cor.test(posterior_emp_NPZ_P1$mean,posterior_gpt2only_NPZ_P1$mean)$estimate
cor.test(posterior_emp_MVRR_P1$mean,posterior_lstmonly_MVRR_P1$mean)$estimate
cor.test(posterior_emp_NPS_P1$mean,posterior_lstmonly_NPS_P1$mean)$estimate
cor.test(posterior_emp_NPZ_P1$mean,posterior_lstmonly_NPZ_P1$mean)$estimate
...
cor.test(posterior_emp_MVRR_P2$mean,posterior_gpt2only_MVRR_P2$mean)$estimate
cor.test(posterior_emp_NPS_P2$mean,posterior_gpt2only_NPS_P2$mean)$estimate
cor.test(posterior_emp_NPZ_P2$mean,posterior_gpt2only_NPZ_P2$mean)$estimate
cor.test(posterior_emp_MVRR_P2$mean,posterior_lstmonly_MVRR_P2$mean)$estimate
cor.test(posterior_emp_NPS_P2$mean,posterior_lstmonly_NPS_P2$mean)$estimate
cor.test(posterior_emp_NPZ_P2$mean,posterior_lstmonly_NPZ_P2$mean)$estimate
cor.test(posterior_emp_NPS_P2$mean,posterior_gpt2_NPS_P2$mean)$estimate
cor.test(posterior_emp_NPZ_P2$mean,posterior_gpt2_NPZ_P2$mean)$estimate
cor.test(posterior_emp_MVRR_P2$mean,posterior_lstm_MVRR_P2$mean)$estimate
cor.test(posterior_emp_NPS_P2$mean,posterior_lstm_NPS_P2$mean)$estimate
cor.test(posterior_emp_NPZ_P2$mean,posterior_lstm_NPZ_P2$mean)$estimate
cor.test(posterior_emp_MVRR_P2$mean,posterior_nosurp_MVRR_P2$mean)$estimate
cor.test(posterior_emp_NPS_P2$mean,posterior_nosurp_NPS_P2$mean)$estimate
cor.test(posterior_emp_NPZ_P2$mean,posterior_nosurp_NPZ_P2$mean)$estimate
...
posterior_lstmonly_MVRR_P0$model <- "lstmonly" 
posterior_lstmonly_MVRR_P1$model <- "lstmonly" 
posterior_lstmonly_MVRR_P2$model <- "lstmonly" 
posterior_gpt2only_MVRR_P0$model <- "gpt2only" 
posterior_gpt2only_MVRR_P1$model <- "gpt2only" 
posterior_gpt2only_MVRR_P2$model <- "gpt2only" 
...
posterior_lstmonly_NPS_P0$model <- "lstmonly" 
posterior_lstmonly_NPS_P1$model <- "lstmonly" 
posterior_lstmonly_NPS_P2$model <- "lstmonly" 
posterior_gpt2only_NPS_P0$model <- "gpt2only" 
posterior_gpt2only_NPS_P1$model <- "gpt2only" 
posterior_gpt2only_NPS_P2$model <- "gpt2only" 
...
posterior_lstmonly_NPZ_P0$model <- "lstmonly" 
posterior_lstmonly_NPZ_P1$model <- "lstmonly" 
posterior_lstmonly_NPZ_P2$model <- "lstmonly" 
posterior_gpt2only_NPZ_P0$model <- "gpt2only" 
posterior_gpt2only_NPZ_P1$model <- "gpt2only" 
posterior_gpt2only_NPZ_P2$model <- "gpt2only" 
posterior_nosurp_NPZ_P0$model <- "nosurp" 
posterior_nosurp_NPZ_P1$model <- "nosurp" 
posterior_nosurp_NPZ_P2$model <- "nosurp" 

df_pointestimate <- 
  data.frame(emp=c(posterior_emp_MVRR_P0$mean,posterior_emp_NPS_P0$mean,posterior_emp_NPZ_P0$mean,posterior_emp_MVRR_P1$mean,posterior_emp_NPS_P1$mean,posterior_emp_NPZ_P1$mean,posterior_emp_MVRR_P2$mean,posterior_emp_NPS_P2$mean,posterior_emp_NPZ_P2$mean),
             lstm=c(posterior_lstm_MVRR_P0$mean,posterior_lstm_NPS_P0$mean,posterior_lstm_NPZ_P0$mean,posterior_lstm_MVRR_P1$mean,posterior_lstm_NPS_P1$mean,posterior_lstm_NPZ_P1$mean,posterior_lstm_MVRR_P2$mean,posterior_lstm_NPS_P2$mean,posterior_lstm_NPZ_P2$mean),
             gpt2=c(posterior_gpt2_MVRR_P0$mean,posterior_gpt2_NPS_P0$mean,posterior_gpt2_NPZ_P0$mean,posterior_gpt2_MVRR_P1$mean,posterior_gpt2_NPS_P1$mean,posterior_gpt2_NPZ_P1$mean,posterior_gpt2_MVRR_P2$mean,posterior_gpt2_NPS_P2$mean,posterior_gpt2_NPZ_P2$mean),
             lstmonly=c(posterior_lstmonly_MVRR_P0$mean,posterior_lstmonly_NPS_P0$mean,posterior_lstmonly_NPZ_P0$mean,posterior_lstmonly_MVRR_P1$mean,posterior_lstmonly_NPS_P1$mean,posterior_lstmonly_NPZ_P1$mean,posterior_lstmonly_MVRR_P2$mean,posterior_lstmonly_NPS_P2$mean,posterior_lstmonly_NPZ_P2$mean),
             gptonly=c(posterior_gpt2only_MVRR_P0$mean,posterior_gpt2only_NPS_P0$mean,posterior_gpt2only_NPZ_P0$mean,posterior_gpt2only_MVRR_P1$mean,posterior_gpt2only_NPS_P1$mean,posterior_gpt2only_NPZ_P1$mean,posterior_gpt2only_MVRR_P2$mean,posterior_gpt2only_NPS_P2$mean,posterior_gpt2only_NPZ_P2$mean),
             nosurp=c(posterior_nosurp_MVRR_P0$mean,posterior_nosurp_NPS_P0$mean,posterior_nosurp_NPZ_P0$mean,posterior_nosurp_MVRR_P1$mean,posterior_nosurp_NPS_P1$mean,posterior_nosurp_NPZ_P1$mean,posterior_nosurp_MVRR_P2$mean,posterior_nosurp_NPS_P2$mean,posterior_nosurp_NPZ_P2$mean),
             EOI=rep(c("GPE_MVRR","GPE_NPS","GPE_NPZ"),each=24),
             item=rep(1:24,9),
             ROI=rep(c(0,1,2),each=72))
