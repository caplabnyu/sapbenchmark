...
#lstmonly_RC_P0 <- readRDS("RelativeClause/fit_verb_bayes_pred_prior1_lstmonly.rds")
#lstmonly_RC_P1 <- readRDS("RelativeClause/fit_det_bayes_pred_prior1_lstmonly.rds")
#lstmonly_RC_P2 <- readRDS("RelativeClause/fit_noun_bayes_pred_prior1_lstmonly.rds")
#gpt2only_RC_P0 <- readRDS("RelativeClause/fit_verb_bayes_pred_prior1_gpt2only.rds")
#gpt2only_RC_P1 <- readRDS("RelativeClause/fit_det_bayes_pred_prior1_gpt2only.rds")
#gpt2only_RC_P2 <- readRDS("RelativeClause/fit_noun_bayes_pred_prior1_gpt2only.rds")
...
gpt2_RC_P0_posterior_samp <- posterior_samples(gpt2_RC_P0, fixed=TRUE, pars=
                                                c("b_Intercept","b_Type_num",randomslope_names))
lstmonly_RC_P0_posterior_samp <- posterior_samples(lstmonly_RC_P0, fixed=TRUE, pars=
                                                 c("b_Intercept","b_Type_num",randomslope_names))
gpt2only_RC_P0_posterior_samp <- posterior_samples(gpt2only_RC_P0, fixed=TRUE, pars=
                                                 c("b_Intercept","b_Type_num",randomslope_names))
...
gpt2_RC_P1_posterior_samp <- posterior_samples(gpt2_RC_P1, fixed=TRUE, pars=
                                                c("b_Intercept","b_Type_num",randomslope_names))
lstmonly_RC_P1_posterior_samp <- posterior_samples(lstmonly_RC_P1, fixed=TRUE, pars=
                                                 c("b_Intercept","b_Type_num",randomslope_names))
gpt2only_RC_P1_posterior_samp <- posterior_samples(gpt2only_RC_P1, fixed=TRUE, pars=
                                                 c("b_Intercept","b_Type_num",randomslope_names))
...
gpt2_RC_P2_posterior_samp <- posterior_samples(gpt2_RC_P2, fixed=TRUE, pars=
                                                c("b_Intercept","b_Type_num",randomslope_names))
lstmonly_RC_P2_posterior_samp <- posterior_samples(lstmonly_RC_P2, fixed=TRUE, pars=
                                                 c("b_Intercept","b_Type_num",randomslope_names))
gpt2only_RC_P2_posterior_samp <- posterior_samples(gpt2only_RC_P2, fixed=TRUE, pars=
                                                 c("b_Intercept","b_Type_num",randomslope_names))
...
lstmonly_RC_P0, gpt2only_RC_P0,lstmonly_RC_P1, gpt2only_RC_P1,lstmonly_RC_P2, gpt2only_RC_P2)
...
#saveRDS(lstmonly_RC_P0_posterior_samp,"RelativeClause/lstmonly_RC_P0_posterior_samp.rds")
#saveRDS(gpt2only_RC_P0_posterior_samp,"RelativeClause/gpt2only_RC_P0_posterior_samp.rds")
...
#saveRDS(lstmonly_RC_P1_posterior_samp,"RelativeClause/lstmonly_RC_P1_posterior_samp.rds")
#saveRDS(gpt2only_RC_P1_posterior_samp,"RelativeClause/gpt2only_RC_P1_posterior_samp.rds")
...
#saveRDS(lstmonly_RC_P2_posterior_samp,"RelativeClause/lstmonly_RC_P2_posterior_samp.rds")
#saveRDS(gpt2only_RC_P2_posterior_samp,"RelativeClause/gpt2only_RC_P2_posterior_samp.rds")
...
lstmonly_RC_P0_posterior_samp <- readRDS("RelativeClause/lstmonly_RC_P0_posterior_samp.rds")
gpt2only_RC_P0_posterior_samp <- readRDS("RelativeClause/gpt2only_RC_P0_posterior_samp.rds")
...
lstmonly_RC_P1_posterior_samp <- readRDS("RelativeClause/lstmonly_RC_P1_posterior_samp.rds")
gpt2only_RC_P1_posterior_samp <- readRDS("RelativeClause/gpt2only_RC_P1_posterior_samp.rds")
...
lstmonly_RC_P2_posterior_samp <- readRDS("RelativeClause/lstmonly_RC_P2_posterior_samp.rds")
gpt2only_RC_P2_posterior_samp <- readRDS("RelativeClause/gpt2only_RC_P2_posterior_samp.rds")
...
posterior_lstmonly_RC_P0 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=25:48,EOI="RC",ROI=0)
posterior_lstmonly_RC_P1 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=25:48,EOI="RC",ROI=1)
posterior_lstmonly_RC_P2 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=25:48,EOI="RC",ROI=2)
posterior_gpt2only_RC_P0 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=25:48,EOI="RC",ROI=0)
posterior_gpt2only_RC_P1 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=25:48,EOI="RC",ROI=1)
posterior_gpt2only_RC_P2 <- data.frame(mean=rep(NA,24),SE=rep(NA,24),upper=rep(NA,24),lower=rep(NA,24),item=25:48,EOI="RC",ROI=2)
...
emp_RC_P0_posterior_samp[,(1+ncols):(24+ncols)] <- emp_RC_P0_posterior_samp[,2]+emp_RC_P0_posterior_samp[,(1+26):(24+26)]
emp_RC_P1_posterior_samp[,(1+ncols):(24+ncols)] <- emp_RC_P1_posterior_samp[,2]+emp_RC_P1_posterior_samp[,(1+26):(24+26)]
emp_RC_P2_posterior_samp[,(1+ncols):(24+ncols)] <- emp_RC_P2_posterior_samp[,2]+emp_RC_P2_posterior_samp[,(1+26):(24+26)]
emp_RC_P0_posterior_samp[,(25+ncols):(48+ncols)] <- emp_RC_P0_posterior_samp[,1]+emp_RC_P0_posterior_samp[,(1+2):(24+2)]
emp_RC_P1_posterior_samp[,(25+ncols):(48+ncols)] <- emp_RC_P1_posterior_samp[,1]+emp_RC_P1_posterior_samp[,(1+2):(24+2)]
emp_RC_P2_posterior_samp[,(25+ncols):(48+ncols)] <- emp_RC_P2_posterior_samp[,1]+emp_RC_P2_posterior_samp[,(1+2):(24+2)]
lstm_RC_P0_posterior_samp[,(1+ncols):(24+ncols)] <- lstm_RC_P0_posterior_samp[,2]+lstm_RC_P0_posterior_samp[,(1+26):(24+26)]
lstm_RC_P1_posterior_samp[,(1+ncols):(24+ncols)] <- lstm_RC_P1_posterior_samp[,2]+lstm_RC_P1_posterior_samp[,(1+26):(24+26)]
lstm_RC_P2_posterior_samp[,(1+ncols):(24+ncols)] <- lstm_RC_P2_posterior_samp[,2]+lstm_RC_P2_posterior_samp[,(1+26):(24+26)]
gpt2_RC_P0_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2_RC_P0_posterior_samp[,2]+gpt2_RC_P0_posterior_samp[,(1+26):(24+26)]
gpt2_RC_P1_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2_RC_P1_posterior_samp[,2]+gpt2_RC_P1_posterior_samp[,(1+26):(24+26)]
gpt2_RC_P2_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2_RC_P2_posterior_samp[,2]+gpt2_RC_P2_posterior_samp[,(1+26):(24+26)]
lstmonly_RC_P0_posterior_samp[,(1+ncols):(24+ncols)] <- lstmonly_RC_P0_posterior_samp[,2]+lstmonly_RC_P0_posterior_samp[,(1+26):(24+26)]
lstmonly_RC_P1_posterior_samp[,(1+ncols):(24+ncols)] <- lstmonly_RC_P1_posterior_samp[,2]+lstmonly_RC_P1_posterior_samp[,(1+26):(24+26)]
lstmonly_RC_P2_posterior_samp[,(1+ncols):(24+ncols)] <- lstmonly_RC_P2_posterior_samp[,2]+lstmonly_RC_P2_posterior_samp[,(1+26):(24+26)]
gpt2only_RC_P0_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2only_RC_P0_posterior_samp[,2]+gpt2only_RC_P0_posterior_samp[,(1+26):(24+26)]
gpt2only_RC_P1_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2only_RC_P1_posterior_samp[,2]+gpt2only_RC_P1_posterior_samp[,(1+26):(24+26)]
gpt2only_RC_P2_posterior_samp[,(1+ncols):(24+ncols)] <- gpt2only_RC_P2_posterior_samp[,2]+gpt2only_RC_P2_posterior_samp[,(1+26):(24+26)]
nosurp_RC_P0_posterior_samp[,(1+ncols):(24+ncols)] <- nosurp_RC_P0_posterior_samp[,2]+nosurp_RC_P0_posterior_samp[,(1+26):(24+26)]
nosurp_RC_P1_posterior_samp[,(1+ncols):(24+ncols)] <- nosurp_RC_P1_posterior_samp[,2]+nosurp_RC_P1_posterior_samp[,(1+26):(24+26)]
nosurp_RC_P2_posterior_samp[,(1+ncols):(24+ncols)] <- nosurp_RC_P2_posterior_samp[,2]+nosurp_RC_P2_posterior_samp[,(1+26):(24+26)]
...
for(i in 1:24){
  ...
  posterior_lstmonly_RC_P0[i,]$mean <- mean(lstmonly_RC_P0_posterior_samp[,i+ncols])
  posterior_lstmonly_RC_P0[i,]$SE <- sd(lstmonly_RC_P0_posterior_samp[,i+ncols])
  posterior_lstmonly_RC_P0[i,]$upper <- quantile(lstmonly_RC_P0_posterior_samp[,i+ncols],0.975)
  posterior_lstmonly_RC_P0[i,]$lower <- quantile(lstmonly_RC_P0_posterior_samp[,i+ncols],0.025)
  posterior_lstmonly_RC_P1[i,]$mean <- mean(lstmonly_RC_P1_posterior_samp[,i+ncols])
  posterior_lstmonly_RC_P1[i,]$SE <- sd(lstmonly_RC_P1_posterior_samp[,i+ncols])
  posterior_lstmonly_RC_P1[i,]$upper <- quantile(lstmonly_RC_P1_posterior_samp[,i+ncols],0.975)
  posterior_lstmonly_RC_P1[i,]$lower <- quantile(lstmonly_RC_P1_posterior_samp[,i+ncols],0.025)
  posterior_lstmonly_RC_P2[i,]$mean <- mean(lstmonly_RC_P2_posterior_samp[,i+ncols])
  posterior_lstmonly_RC_P2[i,]$SE <- sd(lstmonly_RC_P2_posterior_samp[,i+ncols])
  posterior_lstmonly_RC_P2[i,]$upper <- quantile(lstmonly_RC_P2_posterior_samp[,i+ncols],0.975)
  posterior_lstmonly_RC_P2[i,]$lower <- quantile(lstmonly_RC_P2_posterior_samp[,i+ncols],0.025)
  posterior_gpt2only_RC_P0[i,]$mean <- mean(gpt2only_RC_P0_posterior_samp[,i+ncols])
  posterior_gpt2only_RC_P0[i,]$SE <- sd(gpt2only_RC_P0_posterior_samp[,i+ncols])
  posterior_gpt2only_RC_P0[i,]$upper <- quantile(gpt2only_RC_P0_posterior_samp[,i+ncols],0.975)
  posterior_gpt2only_RC_P0[i,]$lower <- quantile(gpt2only_RC_P0_posterior_samp[,i+ncols],0.025)
  posterior_gpt2only_RC_P1[i,]$mean <- mean(gpt2only_RC_P1_posterior_samp[,i+ncols])
  posterior_gpt2only_RC_P1[i,]$SE <- sd(gpt2only_RC_P1_posterior_samp[,i+ncols])
  posterior_gpt2only_RC_P1[i,]$upper <- quantile(gpt2only_RC_P1_posterior_samp[,i+ncols],0.975)
  posterior_gpt2only_RC_P1[i,]$lower <- quantile(gpt2only_RC_P1_posterior_samp[,i+ncols],0.025)
  posterior_gpt2only_RC_P2[i,]$mean <- mean(gpt2only_RC_P2_posterior_samp[,i+ncols])
  posterior_gpt2only_RC_P2[i,]$SE <- sd(gpt2only_RC_P2_posterior_samp[,i+ncols])
  posterior_gpt2only_RC_P2[i,]$upper <- quantile(gpt2only_RC_P2_posterior_samp[,i+ncols],0.975)
  posterior_gpt2only_RC_P2[i,]$lower <- quantile(gpt2only_RC_P2_posterior_samp[,i+ncols],0.025)
...
by_item_SRC <- data.frame(item=c(posterior_emp_SRC_P0$item,posterior_emp_SRC_P1$item,posterior_emp_SRC_P2$item),
                      ROI=c(posterior_emp_SRC_P0$ROI,posterior_emp_SRC_P1$ROI,posterior_emp_SRC_P2$ROI),
                      coef="SRC",
                      mean=c(posterior_emp_SRC_P0$mean,posterior_emp_SRC_P1$mean,posterior_emp_SRC_P2$mean),
                      lower=c(posterior_emp_SRC_P0$lower,posterior_emp_SRC_P1$lower,posterior_emp_SRC_P2$lower),
                      upper=c(posterior_emp_SRC_P0$upper,posterior_emp_SRC_P1$upper,posterior_emp_SRC_P2$upper))
...
by_item_lstmonly <- data.frame(item=c(posterior_lstmonly_RC_P0$item,posterior_lstmonly_RC_P1$item,posterior_lstmonly_RC_P2$item),
                           ROI=c(posterior_lstmonly_RC_P0$ROI,posterior_lstmonly_RC_P1$ROI,posterior_lstmonly_RC_P2$ROI),
                           coef="RC",
                           mean=c(posterior_lstmonly_RC_P0$mean,posterior_lstmonly_RC_P1$mean,posterior_lstmonly_RC_P2$mean),
                           lower=c(posterior_lstmonly_RC_P0$lower,posterior_lstmonly_RC_P1$lower,posterior_lstmonly_RC_P2$lower),
                           upper=c(posterior_lstmonly_RC_P0$upper,posterior_lstmonly_RC_P1$upper,posterior_lstmonly_RC_P2$upper))
by_item_gpt2only <- data.frame(item=c(posterior_gpt2only_RC_P0$item,posterior_gpt2only_RC_P1$item,posterior_gpt2only_RC_P2$item),
                           ROI=c(posterior_gpt2only_RC_P0$ROI,posterior_gpt2only_RC_P1$ROI,posterior_gpt2only_RC_P2$ROI),
                           coef="RC",
                           mean=c(posterior_gpt2only_RC_P0$mean,posterior_gpt2only_RC_P1$mean,posterior_gpt2only_RC_P2$mean),
                           lower=c(posterior_gpt2only_RC_P0$lower,posterior_gpt2only_RC_P1$lower,posterior_gpt2only_RC_P2$lower),
                           upper=c(posterior_gpt2only_RC_P0$upper,posterior_gpt2only_RC_P1$upper,posterior_gpt2only_RC_P2$upper))
...
by_item_SRC <- arrange(by_item_SRC,item,ROI,coef)
...
saveRDS(by_item_SRC,"RelativeClause/by_item_SRC.rds")
...
saveRDS(by_item_lstmonly,"RelativeClause/by_item_lstmonly.rds")
saveRDS(by_item_gpt2only,"RelativeClause/by_item_gpt2only.rds")
...
by_construction_lstmonly <- data.frame(ROI=c(0,1,2),coef="RC",mean=c(mean(lstmonly_RC_P0_posterior_samp$b_Type_num),mean(lstmonly_RC_P1_posterior_samp$b_Type_num),mean(lstmonly_RC_P2_posterior_samp$b_Type_num)),
                                   lower=c(quantile(lstmonly_RC_P0_posterior_samp$b_Type_num,0.025),quantile(lstmonly_RC_P1_posterior_samp$b_Type_num,0.025),quantile(lstmonly_RC_P2_posterior_samp$b_Type_num,0.025)),
                                   upper=c(quantile(lstmonly_RC_P0_posterior_samp$b_Type_num,0.975),quantile(lstmonly_RC_P1_posterior_samp$b_Type_num,0.975),quantile(lstmonly_RC_P2_posterior_samp$b_Type_num,0.975)))
by_construction_gpt2only <- data.frame(ROI=c(0,1,2),coef="RC",mean=c(mean(gpt2only_RC_P0_posterior_samp$b_Type_num),mean(gpt2only_RC_P1_posterior_samp$b_Type_num),mean(gpt2only_RC_P2_posterior_samp$b_Type_num)),
                                   lower=c(quantile(gpt2only_RC_P0_posterior_samp$b_Type_num,0.025),quantile(gpt2only_RC_P1_posterior_samp$b_Type_num,0.025),quantile(gpt2only_RC_P2_posterior_samp$b_Type_num,0.025)),
                                   upper=c(quantile(gpt2only_RC_P0_posterior_samp$b_Type_num,0.975),quantile(gpt2only_RC_P1_posterior_samp$b_Type_num,0.975),quantile(gpt2only_RC_P2_posterior_samp$b_Type_num,0.975)))
...
saveRDS(by_construction_lstmonly,"RelativeClause/by_construction_lstmonly.rds")
saveRDS(by_construction_gpt2only,"RelativeClause/by_construction_gpt2only.rds")
saveRDS(by_construction_nosurp,"RelativeClause/by_construction_nosurp.rds")

#P0
sampled_correlations_P0 <- data.frame(Correlation=rep(NA,5000),EOI=rep("RC",5000),model=rep(c("lstm","gpt2","nosurp","lstmonly","gpt2only"),1000),ROI=0)
for(i in 1:1000){
  posterior_onesampleeachitem <- data.frame(emp=rep(NA,24),lstm=rep(NA,24),gpt2=rep(NA,24),nosurp=rep(NA,24),lstmonly=rep(NA,24),gpt2only=rep(NA,24),EOI=rep("RC",24))
  for(j in 1:24){
    ...
    posterior_onesampleeachitem[j,5] <- sample(lstmonly_RC_P0_posterior_samp[,j+ncols],1)
    posterior_onesampleeachitem[j,6] <- sample(gpt2only_RC_P0_posterior_samp[,j+ncols],1)
  }
  sampled_correlations_P0[((i-1)*5+1):((i-1)*5+5),'Correlation'] <- c(cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,2])$estimate,
...
#P1
sampled_correlations_P1 <- data.frame(Correlation=rep(NA,5000),EOI=rep("RC",5000),model=rep(c("lstm","gpt2","nosurp","lstmonly","gpt2only"),1000),ROI=1)
for(i in 1:1000){
  posterior_onesampleeachitem <- data.frame(emp=rep(NA,24),lstm=rep(NA,24),gpt2=rep(NA,24),nosurp=rep(NA,24),lstmonly=rep(NA,24),gpt2only=rep(NA,24),EOI=rep("RC",24))
  for(j in 1:24){
    ...
    posterior_onesampleeachitem[j,5] <- sample(lstmonly_RC_P1_posterior_samp[,j+ncols],1)
    posterior_onesampleeachitem[j,6] <- sample(gpt2only_RC_P1_posterior_samp[,j+ncols],1)
  }
  sampled_correlations_P1[((i-1)*5+1):((i-1)*5+5),'Correlation'] <- c(cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,2])$estimate,
                                                                      cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,3])$estimate,
                                                                      cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,4])$estimate,
                                                                      cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,5])$estimate,
                                                                      cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,6])$estimate)
...
#P2
sampled_correlations_P2 <- data.frame(Correlation=rep(NA,5000),EOI=rep("RC",5000),model=rep(c("lstm","gpt2","nosurp","lstmonly","gpt2only"),1000),ROI=2)
for(i in 1:1000){
  posterior_onesampleeachitem <- data.frame(emp=rep(NA,24),lstm=rep(NA,24),gpt2=rep(NA,24),lstmonly=rep(NA,24),gpt2only=rep(NA,24),nosurp=rep(NA,24),EOI=rep("RC",24))
  for(j in 1:24){
    ...
    posterior_onesampleeachitem[j,5] <- sample(lstmonly_RC_P2_posterior_samp[,j+ncols],1)
    posterior_onesampleeachitem[j,6] <- sample(gpt2only_RC_P2_posterior_samp[,j+ncols],1)
  }
  sampled_correlations_P2[((i-1)*5+1):((i-1)*5+5),'Correlation'] <- c(cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,2])$estimate,
                                                                      cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,3])$estimate,
                                                                      cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,4])$estimate,
                                                                      cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,5])$estimate,
                                                                      cor.test(posterior_onesampleeachitem[1:24,1],posterior_onesampleeachitem[1:24,6])$estimate)
...
cor.test(posterior_emp_RC_P0$mean,posterior_gpt2only_RC_P0$mean)$estimate
cor.test(posterior_emp_RC_P0$mean,posterior_lstmonly_RC_P0$mean)$estimate
...
cor.test(posterior_emp_RC_P1$mean,posterior_gpt2only_RC_P1$mean)$estimate
cor.test(posterior_emp_RC_P1$mean,posterior_lstmonly_RC_P1$mean)$estimate
...
cor.test(posterior_emp_RC_P2$mean,posterior_gpt2only_RC_P2$mean)$estimate
cor.test(posterior_emp_RC_P2$mean,posterior_lstmonly_RC_P2$mean)$estimate
...
posterior_lstmonly_RC_P0$model <- "lstmonly" 
posterior_lstmonly_RC_P1$model <- "lstmonly" 
posterior_lstmonly_RC_P2$model <- "lstmonly"
posterior_gpt2only_RC_P0$model <- "gpt2only" 
posterior_gpt2only_RC_P1$model <- "gpt2only" 
posterior_gpt2only_RC_P2$model <- "gpt2only" 
...
df_pointestimate <- 
  data.frame(emp=c(posterior_emp_RC_P0$mean,posterior_emp_RC_P1$mean,posterior_emp_RC_P2$mean),
             ...
             lstmonly=c(posterior_lstmonly_RC_P0$mean,posterior_lstmonly_RC_P1$mean,posterior_lstmonly_RC_P2$mean),
             gpt2only=c(posterior_gpt2only_RC_P0$mean,posterior_lstmonly_RC_P1$mean,posterior_lstmonly_RC_P2$mean),
