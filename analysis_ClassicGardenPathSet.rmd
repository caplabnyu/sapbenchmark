...
#cor.test(as.vector(colMeans(psamp_P0_AMBxCONSTR[,148:171])),lm_prediction$ITEM72_MEAN_P0[lm_prediction$Type=="MVRR"])
...
#cor.test(as.vector(colMeans(psamp_P0_AMBxCONSTR[,172:195])),lm_prediction$ITEM72_MEAN_P0[lm_prediction$Type=="NPS"])
...
#cor.test(as.vector(colMeans(psamp_P0_AMBxCONSTR[,196:219])),lm_prediction$ITEM72_MEAN_P0[lm_prediction$Type=="NPZ"])
...
#cor.test(as.vector(colMeans(psamp_P1_AMBxCONSTR[,148:171])),lm_prediction$ITEM72_MEAN_P1[lm_prediction$Type=="MVRR"])
...
#cor.test(as.vector(colMeans(psamp_P1_AMBxCONSTR[,172:195])),lm_prediction$ITEM72_MEAN_P1[lm_prediction$Type=="NPS"])
...
#cor.test(as.vector(colMeans(psamp_P1_AMBxCONSTR[,196:219])),lm_prediction$ITEM72_MEAN_P1[lm_prediction$Type=="NPZ"])
...
```{r}
lm_prediction <- lm_prediction%>%group_by(Type)%>%mutate(Rank=rank(ITEM_MEAN_P0))%>%ungroup()
ggplot(lm_prediction,aes(x=Rank,y=ITEM_MEAN_P0,colour=Type))+
  facet_wrap(~Type)+
  geom_point()+
